...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(noinst_HEADERS) COPYING compile install-sh missing
...
cramore_DEPENDENCIES = $(am__DEPENDENCIES_2)
AM_V_P = $(am__v_P_$(V))
...
ACLOCAL = ${SHELL} /Users/hmkang/code/git/cramore/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /Users/hmkang/code/git/cramore/missing automake-1.14
AWK = awk
CC = gcc
...
PACKAGE_STRING = cramore 5df77e4
PACKAGE_TARNAME = cramore
PACKAGE_URL = 
PACKAGE_VERSION = 5df77e4
PATH_SEPARATOR = :
POW_LIB = 
SET_MAKE = 
SHELL = /bin/sh
