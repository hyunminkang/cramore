...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog COPYING \
	...
	$(srcdir)/config.h.in $(srcdir)/config.mk.in depcomp \
	$(noinst_HEADERS) compile install-sh missing
...
ACLOCAL = ${SHELL} /home/hmkang/code/working/cramore/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AUTOMAKE = ${SHELL} /home/hmkang/code/working/cramore/missing automake-1.14
AWK = gawk
CC = gcc
...
PACKAGE_STRING = cramore 994fe4a-dirty
PACKAGE_TARNAME = cramore
PACKAGE_URL = 
PACKAGE_VERSION = 994fe4a-dirty
PATH_SEPARATOR = :
POW_LIB = 
SET_MAKE = 
SHELL = /bin/sh
STRIP = 
VERSION = 994fe4a-dirty
