...
am_cramore_OBJECTS = cramore.$(OBJEXT) Error.$(OBJEXT) \
	...
	cmd_cram_dsc_pileup.$(OBJEXT) cmd_cram_dsc_dump.$(OBJEXT) \
	cmd_dge_shuffle.$(OBJEXT)
...
ACLOCAL = ${SHELL} /home/hmkang/code/working/cramore/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/hmkang/code/working/cramore/missing autoconf
AUTOHEADER = ${SHELL} /home/hmkang/code/working/cramore/missing autoheader
AUTOMAKE = ${SHELL} /home/hmkang/code/working/cramore/missing automake-1.15
AWK = gawk
CC = gcc
...
LIBS = -lz 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/hmkang/code/working/cramore/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cramore
PACKAGE_BUGREPORT = hmkang@umich.edu
PACKAGE_NAME = cramore
PACKAGE_STRING = cramore 1.8-9b2dd77-dirty
PACKAGE_TARNAME = cramore
PACKAGE_URL = 
PACKAGE_VERSION = 1.8-9b2dd77-dirty
PATH_SEPARATOR = :
POW_LIB = 
SET_MAKE = 
SHELL = /bin/sh
STRIP = 
VERSION = 1.8-9b2dd77-dirty
...
abs_top_srcdir = /home/hmkang/code/working/cramore
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/hmkang/code/working/cramore/install-sh
...
include ./$(DEPDIR)/MathGenMin.Po
include ./$(DEPDIR)/MathGold.Po
include ./$(DEPDIR)/MathMatrix.Po
include ./$(DEPDIR)/MathVector.Po
include ./$(DEPDIR)/PhredHelper.Po
include ./$(DEPDIR)/Random.Po
include ./$(DEPDIR)/Sort.Po
include ./$(DEPDIR)/allele.Po
include ./$(DEPDIR)/ancestry_estimator.Po
include ./$(DEPDIR)/augmented_bam_record.Po
include ./$(DEPDIR)/bam_ordered_reader.Po
include ./$(DEPDIR)/bcf_chunked_reader.Po
include ./$(DEPDIR)/bcf_filtered_reader.Po
include ./$(DEPDIR)/bcf_ordered_reader.Po
include ./$(DEPDIR)/bcf_ordered_writer.Po
include ./$(DEPDIR)/cmd_bed_delta_svm_train.Po
include ./$(DEPDIR)/cmd_bed_matched_shuffle.Po
include ./$(DEPDIR)/cmd_bed_shuffle.Po
include ./$(DEPDIR)/cmd_bgen_to_vcf.Po
include ./$(DEPDIR)/cmd_cram_context_indel_analysis.Po
include ./$(DEPDIR)/cmd_cram_demuxlet.Po
include ./$(DEPDIR)/cmd_cram_dense_genotype.Po
include ./$(DEPDIR)/cmd_cram_digital_pileup.Po
include ./$(DEPDIR)/cmd_cram_dsc_dump.Po
...
include ./$(DEPDIR)/cmd_cram_procap_detect.Po
include ./$(DEPDIR)/cmd_cram_simul_contam.Po
include ./$(DEPDIR)/cmd_cram_simuxlet.Po
include ./$(DEPDIR)/cmd_cram_sparse_genotype.Po
...
include ./$(DEPDIR)/cmd_dge_shuffle.Po
include ./$(DEPDIR)/cmd_fasta_gc_content.Po
include ./$(DEPDIR)/cmd_plp_find_mux_clust.Po
include ./$(DEPDIR)/cmd_plp_make_dge_matrix.Po
include ./$(DEPDIR)/cmd_sc_kallisto_count.Po
include ./$(DEPDIR)/cmd_sc_map_stamps.Po
include ./$(DEPDIR)/cmd_sc_multinom_em.Po
...
include ./$(DEPDIR)/cmd_vcf_merge_candidate_variants.Po
include ./$(DEPDIR)/cmd_vcf_normalize_depth.Po
include ./$(DEPDIR)/cmd_vcf_paste_calls.Po
...
include ./$(DEPDIR)/frequency_estimator.Po
include ./$(DEPDIR)/genomeChunk.Po
include ./$(DEPDIR)/genome_interval.Po
include ./$(DEPDIR)/genotype_concordance.Po
include ./$(DEPDIR)/gtf.Po
include ./$(DEPDIR)/hts_utils.Po
include ./$(DEPDIR)/interval.Po
include ./$(DEPDIR)/interval_tree.Po
include ./$(DEPDIR)/joint_genotype_block_reader.Po
include ./$(DEPDIR)/joint_genotype_block_record.Po
include ./$(DEPDIR)/libsvm.Po
include ./$(DEPDIR)/libsvm_gkm.Po
include ./$(DEPDIR)/log_tool.Po
include ./$(DEPDIR)/nuclear_pedigree.Po
include ./$(DEPDIR)/params.Po
include ./$(DEPDIR)/reference_sequence.Po
include ./$(DEPDIR)/sam_filtered_reader.Po
include ./$(DEPDIR)/sam_ordered_writer.Po
include ./$(DEPDIR)/sc_drop_seq.Po
include ./$(DEPDIR)/sex_ploidy_map.Po
include ./$(DEPDIR)/tsv_reader.Po
include ./$(DEPDIR)/utils.Po
include ./$(DEPDIR)/variant.Po
include ./$(DEPDIR)/variant_manip.Po
include ./$(DEPDIR)/vntr.Po
